  ...
  return order.loading ? (
    ...
    <Fragment>
      ...
      <div className="flex justify-between  w-full gap-1 px-6">
        <div className="w-1/2 p-6 my-10 flex bg-red-100 rounded flex-col justify-between border border-gray-300">
          <div className="w-full">
            <div className="text-3xl text-center text-primary-shade mb-8">Cart Items</div>
                ...
                order.order.items.map((el, index) => {
                  return (
                    <div className="flex justify-between items-center">
                      <i className="fas fa-tags w-10"></i>
                      <div className="w-20">{el.product.productName}</div>
                      <div>#{el.quantity}</div>
          ...
          <div className="flex p-8 justify-between items-center">
            ...
            <div className=" font-bold">{order?.order?.totalPrice}</div>
          </div>
        </div>
        <form
          onSubmit={(e) => onCheckoutSubmit(e)}
          className="form bg-red-100 p-6 my-10 w-1/2 border border-gray-300">
